...
const stakers: Stakers = {
  "/stakers/livepeer": {
    ...
    stakerAddress: "0xc4a49b9DE75A98218bAa42B16818aEF2ef81ba08",
    available: true,
    apy: 23.3,
    logo: "livepeer.svg",
    symbol: "LPT",
  ...
  "/stakers/keep": {
    title: "Keep",
    description:
      "Keep provides a bridge between the world of public blockchains and private data. It enables a new wave of ground-up innovation for blockchain developers",
    stakerAddress: "",
    available: false,
    apy: 8.1,
    logo: "keep.svg",
